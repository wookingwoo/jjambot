...
def writeMenuAsDate_TXT(dic):
    ...
    for y in sorted(dic):
        ...
        for z in sorted(dic[y]):
            path_classify_dir_year = './crawling_data/year_{}'.format(y[0:4])
            path_classify_dir_month = './crawling_data/year_{}/month_{}'.format(y[0:4], y[4:6])
            path_classify = './crawling_data/year_{}/month_{}/{}_menu.dat'.format(y[0:4], y[4:6],
                                                                                  y[0:4] + "_" + y[4:6])
